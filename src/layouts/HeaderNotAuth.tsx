      ...
      <header className="w-full bg-[#0a0a0a] border-b border-zinc-800 text-white">
        <div className="w-full max-w-screen-2xl mx-auto px-4 md:px-8 xl:px-12 h-20 flex items-center justify-between">
          ...
          <nav className="hidden xl:flex items-center gap-6 2xl:gap-10">
            <Link to="/feature" className={`${linkStyle} ${isActive("/feature") ? "text-lime-400" : "text-zinc-100"}`}>Features</Link>
            <Link to="/blog" className={`${linkStyle} ${isActive("/blog") ? "text-lime-400" : "text-zinc-100"}`}>Blog</Link>
            <Link to="/about" className={`${linkStyle} ${isActive("/about") ? "text-lime-400" : "text-zinc-100"}`}>About Us</Link>
          </nav>
